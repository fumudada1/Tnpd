...
namespace tnpd.Areas.precinct6.Controllers
{
    public class ChiefMailboxController : Controller
    {
        ...
        {
            ViewBag.UnId = id.ToString();
            //驗證碼確認, HttpPostedFileBase Upfile1, HttpPostedFileBase Upfile2, HttpPostedFileBase Upfile3
            string sCheckCode = Session["CheckCode"] != null
                ? Session["CheckCode"].ToString().ToLower()
