...
namespace tnpd.Models
{
    public class Utility
    {
        ...
        /// <returns></returns>
        public static bool HasPermission(string pCode)
        {
            return true;
        }
        ...
        /// </summary>
        /// <returns></returns>
        public static bool hasLoginCustomers()
        {
            return HttpContext.Current.Session["tnpdCustomer"] != null ? true : false;
        }
        ...
        #region "加密函式"
        static public string Encoding(string cryString)
        {
            string strReturn = "";
        ...
        public static byte Asc(char ch)
        {
            ...
            return System.Text.Encoding.ASCII.GetBytes(new[] { ch }, 0, 1)[0];
        }
        #endregion
        ...
        public static void SendGmailMail1(string fromAddress, string toAddress, string Subject, string MailBody, string password)
        {
